...
const projects = [
  ...
  { title: "Moody Baby", description: "Line Bot-給學生之情緒價值機器人", image: "/images/moodybaby.jpg", github: "https://github.com/ddhcyw/MoodyBaby", demo: "https://youtu.be/GpwoKHT8Z-Y", linkLabel: "查看Demo", tools: "Node.js, LINE Messaging API, Python", story: "學會串接LINE Messaging API，我設計了情緒回饋卡，完成了雙圖文選單和情緒回饋功能。" },
