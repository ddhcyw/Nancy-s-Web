...
const projects = [
  ...
  { title: "Moody Baby", description: "Line Bot-給學生之情緒價值機器人", image: "/images/moodybaby.jpg", github: "https://github.com/ddhcyw/MoodyBaby", demo: "https://youtu.be/GpwoKHT8Z-Y", linkLabel: "查看Demo", tools: "ngrok, LINE Messaging API, Python", story: "學會串接LINE Messaging API，我設計了情緒回饋卡，完成了雙圖文選單和情緒回饋功能。" },
  { title: "數位奇境 Digital Odyssey(開發中)", description: "Unity 2D教育RPG解謎遊戲", image: "/images/dtdo.png", github: "https://github.com/ddhcyw/DO_test2", demo: "https://www.youtube.com/watch?v=Uj9JFRkuzKY", linkLabel: "查看Demo", tools: "Unity, C#, Procreate, Qwen (Hugging Face), Flask (Python)", story: "和伙伴一起寫企劃，我負責AI助手的系統和場景程式。" },
];
    ...
    <section id="contact" className="py-16 bg-[#F0F8FF]">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="mt-8 flex justify-end gap-6">
          <a 
            href="https://www.instagram.com/ddhcyw" 
            target="_blank" 
            rel="noreferrer"
